	...
	public void defaultValues() {
		...
		switch (currency) {	
			...
			case "Euro":
				...
				this.exchangeValues.put("INR", 87.15);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("INR", 103.13);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR", 82.14);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("INR", 11.10);
				break;
			case "Japanese Yen":
				...
				this.exchangeValues.put("INR", 0.66);
				break;
			case "Rupees":
				this.exchangeValues.put("USD", -74.85);
				this.exchangeValues.put("EUR", -87.15);
				this.exchangeValues.put("GBP", -103.13);
				this.exchangeValues.put("CHF", -82.14);
				this.exchangeValues.put("CHY", -11.10);
